---
title: '온프레미스에서 프론트/백 배포 독립시키기'
publishedAt: '2026-03-31'
summary: 'Spring Boot JAR에 프론트엔드를 말아 배포하던 방식에서 Nginx 경로 분기를 활용한 독립 배포로 전환한 경험. 온프레미스 환경의 제약 속에서 HTTPS 적용, upstream DNS resolve, 무중단 배포까지—실전에서 검증한 Nginx 구성과 운영 노하우.'
